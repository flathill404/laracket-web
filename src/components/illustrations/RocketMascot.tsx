	...
	return (
		...
		>
			...
			<path
				...
				className="fill-white stroke-2 stroke-slate-900"
			/>
			<path
				d="M100 40C100 40 130 70 130 110"
				className="stroke-2 stroke-slate-900 opacity-10"
			/>
			<path
				d="M100 80C100 80 115 80 115 95C115 110 100 110 100 110"
				className="fill-blue-200 stroke-2 stroke-slate-900"
			/>
			<path
				d="M70 110L50 140L80 140"
				className="fill-red-400 stroke-2 stroke-slate-900"
			/>
			<path
			...
			<path
				...
				className="fill-orange-400 stroke-2 stroke-slate-900"
			/>
			<path
				d="M60 20L40 30M140 20L160 30M20 100L10 100M190 100L180 100"
				className="stroke-2 stroke-slate-300"
				strokeLinecap="round"
			/>
		</svg>
	);
